...
using KamiYomu.CrawlerAgents.WeebCentral;
...
ICrawlerAgent crawler = new WeebCentralCrawlerAgent(options);
var results = new List<(string Method, bool Success, string Message)>();

var mangaResult = await crawler.SearchAsync("sak", new PaginationOptions(0, 30), CancellationToken.None);
#endregion
